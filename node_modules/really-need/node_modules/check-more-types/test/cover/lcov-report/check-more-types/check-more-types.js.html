...
<html lang="en">
<head>
    <title>Code coverage report for check-more-types/check-more-types.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">check-more-types/check-more-types.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.12% <small>(101 / 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">92.19% <small>(59 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">check-more-types/</a> &#187; check-more-types.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">(function checkMoreTypes(check) {
  'use strict';
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Cannot find check-types library, has it been loaded?');</span>
  }
&nbsp;
  /**
  ...
  */
  function raises(fn, errorValidator) {
    ...
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof errorValidator === 'function') {
...
&nbsp;
  ...
  //
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!check.defend) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!check.mixin) {
...
&nbsp;
}(typeof window === 'object' ? <span class="branch-0 cbranch-no" title="branch not covered" >window.check </span>: global.check));
&nbsp;</pre></td></tr>
</table></pre>

</div>
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Sep 02 2014 22:30:55 GMT-0400 (EDT)</div>
</div>
